<template>
  <div>
    ...
    <div class="pwd-inp">
      <div class="item" @click="setFocus" v-for="(item,index) in 6" :key="index"><div class="item-dot" v-if="pwdVal.length>index"></div></div>
    </div>
    ...
    setFocus() {
      ...
      if (this.isAndroid) {
        window.addEventListener('resize', function() {
          if (document.activeElement.tagName === 'input' || document.activeElement.tagName === 'INPUT' || document.activeElement.tagName === 'textarea' || document.activeElement.tagName === 'TEXTAREA') {
